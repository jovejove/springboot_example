...
@Data
//@Component
public class ExampleBeanXml implements BeanNameAware, ApplicationContextAware, InitializingBean, DisposableBean {
...
//    }
    ...
    private String beanPostAfterInitialization;
    ...
    public ExampleBeanXml() {
        System.out.println("1 ExampleBean 无参构造");
    }

    public ExampleBeanXml(int years) {
        System.out.println("1 ExampleBean 有参构造years:" + years);
        this.years = years;
    }

    public ExampleBeanXml(int years, String applicationContextAware) {
        this.years = years;
    ...
    public void afterPropertiesSet() {
        ExampleBeanXml exampleBean = applicationContext.getBean(this.getBeanName(), ExampleBeanXml.class);
        exampleBean.setAfterProperty("setAfterProperty");
        System.out.println("4 ExampleBean InitializingBean.afterPropertiesSet()" + JSON.toJSONString(exampleBean));
    }
